package org.face.identify.yitu.request;

import org.apache.log4j.Logger;
import org.face.identify.yitu.vo.FaceQueryRequest;
import org.face.identify.yitu.vo.IdcardRequest;
import org.face.identify.yitu.util.YituHttpRequestUtil;
import org.face.identify.yitu.util.YituConfig;
import org.face.identify.yitu.vo.FaceFeatureRequest;
import org.face.identify.yitu.vo.FaceFeatureResponse;
import org.face.identify.yitu.vo.FaceQueryResponse;
import org.face.identify.yitu.vo.IdcardResponse;
import org.face.identify.yitu.vo.ImgPackageRequest;
import org.face.identify.yitu.vo.ImgPackageResponse;
...
public class YituHttpClientRequest implements YituHttpClient {
	...
	/**
	 * 
	 * @see YituHttpClient#execute(FaceFeatureRequest)
	 */
	@Override
	...
	/**
	 * 
	 * @see YituHttpClient#compareExecute(FaceQueryRequest,
	 *      YituConfig)
	 */
	@Override
	...
	/**
	 * 
	 * @see YituHttpClient#recognizeIdcard(IdcardRequest)
	 */
	@Override
	...
	/**
	 * 
	 * @see YituHttpClient#transImgPackage(ImgPackageRequest)
	 */
	@Override
